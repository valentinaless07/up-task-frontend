  ...
  return (
    ...
    <form onSubmit={handleSubmit} className='my-10 bg-white shadow rounded-lg p-10'>
        ...
        <div className='my-5'>
            ...
            <input id='email' value={email} type='email' placeholder='Email de Registro' 
            className='w-full mt-3 p-3 border rounded-xl bg-gray-50' onChange={e => setEmail(e.target.value)}/>
        </div>
